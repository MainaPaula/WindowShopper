...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({Key? key, this.chatUsersenderId, this.chatUserName}) : super(key: key);

  @override
  State<ChatScreen> createState() => _ChatScreenState(chatUsersenderId, chatUserName);
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  _ChatScreenState(this.chatUsersenderId, this.chatUserName);
